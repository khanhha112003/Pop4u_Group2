    ...
    BlgPosts : [
        {
            ...
            description:'Sau khi các thành viên BTS nhập ngũ, các bài hát của nhóm phát hành cách đây vài năm bất ngờ xuất hiện trên BXH Billboard.',
            category:  ["Tin tức"],
            date: "2023-12-31"
        },
        {
            ...
            description:'Ngày 29/12, truyền thông Hàn Quốc đưa tin, cả 4 thành viên của nhóm nhạc nữ nổi tiếng xứ Hàn Blackpink đều không gia hạn hợp đồng cá nhân với công ty chủ quản, YG Entertainment.',
            category: ["Tin tức"],
            date: "2023-12-31"
        },
        {
            ...
            description:'Ngày 2.1, Xports News đưa tin, Jisoo (Blackpink) sẽ thực hiện các hoạt động solo dưới sự quản lý của công ty gia đình - Biomom - do anh trai ruột thành lập.',
            category: ["Tin tức"],
            date: "2024-01-02"
        },
        {
            ...
            description:'TWICE sẽ có 2 đêm concert tại Nissan vào 27 và 28/7/2024. Đây là SVĐ lớn nhất ở Nhật với sức chứa 72k người. Sau TVXQ!, TWICE là nghệ sĩ K-POP thứ 2 làm được điều này.',
            category: ["Thành tích"],
            date: "2023-12-30"
        },
        {
            ...
            description:'Đến hẹn lại lên, SBS Gayo Daejeon chính là sự kiện âm nhạc được mong đợi nhất dịp cuối năm. Chương trình quy tụ dàn sao cực khủng, toàn những tên tuổi hàng đầu làng giải trí xứ Hàn như: aespa, NewJeans, IVE, ITZY, NCT 127...',
            category: ["Lễ trao giải","Thành tích"],
            date: "2023-12-25"
        },
        {
            id:"6",
            ...
            description:'Ngay từ khi xuất hiện như một thực tập sinh Jennie (Blackpink) đã được chú ý bởi sự khác biệt, phá vỡ mọi quy chuẩn tạo nên một ca sĩ thần tượng ở Kpop.',
            category: ["Lối sống"],
            date: "2023-09-12"
        },
        {
            ...
            description:'Theo đó, ca khúc mới của nhóm BabyMonster có tên Stuck in the middle. Đây là ca khúc tiếp theo của nhóm sau Batter Up và dự kiến ra mắt vào ngày 1-2-2024. ',
            category: ["Tin tức"],
            date: "2023-11-23"
        },
